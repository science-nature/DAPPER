...
print_averages(cfgs,avrgs,statkeys=['rmse_u'])
...
parameters = [(fau, i) for fau in 'fau' for i in arange(len(cfgs))]

@pytest.mark.parametrize(('fau_and_i'),parameters)
def test_value(fau_and_i):
  fau, i = fau_and_i
  assert old[fau][i] == gr([i],fau).pop()
...
old['f'] = \
    [0.19684477973528794 , 0.21429229233638106 , 0.23934387451007286 ,
     ...
     0.19684477973528852 , 0.21429229233638189 , 0.23934387451007347 ,
     0.19684477973528816 , 0.214292292336381   , 0.27369441159900093 ,
     ...
     0.19684477973528844 , 0.21429229233638178 , 0.23934387451007322 ,
     0.19684477973528811 , 0.21429229233638106 , 0.27369441159899971 ,
     0.19684477973528824 , 0.23049048795386023 , 0.19858885018530195 ,
     0.19684477973528802 , 0.214292292336381   , 0.23934387451007286 ,
     0.19684477973528847 , 0.21429229233638178 , 0.23934387451007322 ,
     0.19684477973528847 , 0.21429229233638178 , 0.23934387451007322 ,
     0.19684477973528811 , 0.21429229233638106 , 0.27369441159900088 ,
...
old['u'] = \
    [0.18086911575323916  , 0.19884834546399385  , 0.22350121417062313  ,
     ...
     0.18086911575323966  , 0.19884834546399466  , 0.22350121417062382  ,
     0.18086911575323933  , 0.1988483454639938   , 0.25788868588284042  ,
     ...
     0.10809005405428891  , 0.12872786931335212  , 0.15138717068466845  ,
     0.10809005405428862  , 0.12872786931335148  , 0.18251031013869246  ,
     0.10809005405428862  , 0.14479974441156154  , 0.10969822797890079  ,
     ...
     0.058841803438298215 , 0.08785067218910271  , 0.083764782614185893 ,
     0.058841803438298222 , 0.087850672189102211 , 0.09755236060856956  ,
