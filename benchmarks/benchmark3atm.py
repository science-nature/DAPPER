...
for dtObs in [0.4,4.4,8.9,26.7,62.2]:
  ...
  np.savetxt('./data/strongly/obsATMdtObs/'+str(dtObs)+'/truth.dat',xx)
  np.savetxt('./data/strongly/obsATMdtObs/'+str(dtObs)+'/obs.dat',yyatm)
  ...
  # y6=(xx-fr)[extr,:]
  l=len(s.Xa[:,1,1])
  np.savetxt('./data/strongly/obsATMdtObs/'+str(dtObs)+'/xa1.dat',s.Xa[1,:,:])
  np.savetxt('./data/strongly/obsATMdtObs/'+str(dtObs)+'/xa182.dat',s.Xa[floor(l/2),:,:])
  np.savetxt('./data/strongly/obsATMdtObs/'+str(dtObs)+'/xa363.dat',s.Xa[l-1,:,:])

  l=len(s.Xf[:,1,1])
  np.savetxt('./data/strongly/obsATMdtObs/'+str(dtObs)+'/xf1.dat',s.Xf[1,:,:])
  np.savetxt('./data/strongly/obsATMdtObs/'+str(dtObs)+'/xf182.dat',s.Xf[floor(l/2),:,:])
  np.savetxt('./data/strongly/obsATMdtObs/'+str(dtObs)+'/xf363.dat',s.Xf[l-1,:,:])

  np.savetxt('./data/strongly/obsATMdtObs/'+str(dtObs)+'/obsvar.dat',diag(hatm.noise.C.C))
  # np.savetxt('./data/strongly/obsATMdtObs/'+str(cfg.N)+'/freerun.dat',fr)
  np.savetxt('./data/strongly/obsATMdtObs/'+str(dtObs)+'/ensemblemean.dat',s.mu)
  np.savetxt("./data/strongly/obsATMdtObs/"+str(dtObs)+"/matcovf.dat",y1)
  np.savetxt("./data/strongly/obsATMdtObs/"+str(dtObs)+"/matcova.dat",y2)
  np.savetxt("./data/strongly/obsATMdtObs/"+str(dtObs)+"/errf.dat",y3)
  np.savetxt("./data/strongly/obsATMdtObs/"+str(dtObs)+"/erra.dat",y4)
  # np.savetxt("./data/strongly/obsATMdtObs/"+str(cfg.N)+"/errfr.dat",y6)
  fichier6 = open("./data/strongly/obsATMdtObs/"+str(dtObs)+"/info.dat", "w")
